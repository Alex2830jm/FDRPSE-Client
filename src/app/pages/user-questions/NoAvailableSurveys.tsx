      ...
      <div className="grid lg:grid-cols-7 py-5 lg:py-20 max-w-[2000px]">
        <div className="flex flex-col justify-center col-span-3">
          ...
          <span className="lg:hidden mx-auto my-10">
            <img src="/cuestionario_prueba/public/assets/question-home.svg" alt="home-icon" loading="lazy" width="200" height="200" />
          </span>
        ...
        <div className="hidden col-span-4 lg:flex justify-end">
          <img src="/cuestionario_prueba/public/assets/question-home.svg" alt="home-icon" loading="eager" width="600" height="600" />
        </div>
      </div>
    </div>
  )
